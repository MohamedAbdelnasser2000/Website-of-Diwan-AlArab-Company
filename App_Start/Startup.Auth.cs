...
namespace GovEgy_2
{
    public partial class Startup
    {
        ...
        private void createRplesandUsers()
        {
            ...
            if (!roleManager.RoleExists(RoleName.Ashraf))
            {
                //we create admin role
                var role = new Microsoft.AspNet.Identity.EntityFramework.IdentityRole();
                role.Name = RoleName.Ashraf;
                roleManager.Create(role);

                //we create Admin super user who will maintain the website
                var user = new ApplicationUser();
                user.UserName = "ashraf";
                user.Email = "admin@diwanalarab.com";

                string userPWD = "Aa$123456$aa";
                ...
                {
                    var result1 = UserManager.AddToRole(user.Id, RoleName.Ashraf);
                }
            }
            ...
            if (!roleManager.RoleExists(RoleName.Manager))
            {
                ...
                user.Email = "manager@govegy.com";

                string userPWD = "Mm$123456$mm";
